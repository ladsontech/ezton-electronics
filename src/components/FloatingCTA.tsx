  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
      {isOpen && (
        ...
        >
          <div className="bg-[#25d366] p-3 sm:p-4 text-white flex justify-between items-center">
          ...
          <div className="p-3 sm:p-4">
            ...
            <a 
              ...
              className="flex items-center justify-center gap-2 py-2 px-4 rounded-lg font-medium transition-colors w-full bg-[#25d366] text-white hover:bg-[#22c55e]"
      ...
      <button
        onClick={toggleOpen}
        className={cn(
          "bg-[#25d366] text-white rounded-full p-3 sm:p-4 shadow-lg flex items-center justify-center hover:bg-[#22c55e] transition-colors",
