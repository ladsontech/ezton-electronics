      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <div className="bg-secondary/20 p-5 rounded-lg border border-border/40 shadow-sm opacity-0 animate-fade-in" style={{ animationDelay: "0.5s", animationFillMode: "forwards" }}>
