...
const Hero = () => {
  ...
  return (
    <section className="relative pt-24 sm:pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <h1 
              className={cn(
                "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font-heading leading-tight mb-4 md:mb-6",
            ...
            <p 
              className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 max-w-2xl mx-auto opacity-0 animate-fade-in"
            ...
            {/* Image Carousel */}
            <div 
              className="relative mx-auto mb-8 max-w-3xl rounded-xl overflow-hidden shadow-lg opacity-0 animate-fade-in"
            ...
            >
              <div className="relative aspect-video bg-gray-100">
                ...
                <button 
                  ...
                  className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/70 backdrop-blur-sm flex items-center justify-center shadow-md transition-colors hover:bg-white z-10"
                ...
                <button 
                  ...
                  className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/70 backdrop-blur-sm flex items-center justify-center shadow-md transition-colors hover:bg-white z-10"
        ...
        <div 
          className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 opacity-0 animate-fade-in"
