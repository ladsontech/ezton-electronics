...
const Hero = () => {
  return (
    <section className="relative overflow-hidden rounded-2xl shadow-lg pb-8 pt-20 sm:pb-14 sm:pt-32 md:pt-44 md:pb-28 min-h-[600px] sm:min-h-[670px]">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 relative z-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center">
            ...
            {/* Main headline */}
            <h1 className={cn(
              "text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-playfair font-black leading-tight mb-3 sm:mb-4 md:mb-8 opacity-0 animate-fade-in tracking-tight px-2"
            )} style={{
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 justify-center animate-fade-in opacity-0 px-4" style={{
              ...
              <a 
                href="#services" 
                className="inline-block font-semibold rounded-lg px-6 py-2.5 sm:px-8 sm:py-3 bg-white border border-primary/20 text-primary text-sm sm:text-base shadow-md transition-all hover:bg-primary/10 hover:scale-105"
              >
